...
module.exports = (object, asChild) => {
  ...
  return `${rootTagStart}
	...
	${object.milestoneCriteriaFilterItems == null ? '' : object.milestoneCriteriaFilterItems.map(p => '<milestoneCriteriaFilterItems>' + FilterItem(p, true) + '</milestoneCriteriaFilterItems>')}
	...
	${object.successActions == null ? '' : object.successActions.map(p => '<successActions>' + WorkflowActionReference(p, true) + '</successActions>')}
	${object.timeTriggers == null ? '' : object.timeTriggers.map(p => '<timeTriggers>' + EntitlementProcessMilestoneTimeTrigger(p, true) + '</timeTriggers>')}
