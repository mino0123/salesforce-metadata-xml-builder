...
module.exports = (object, asChild) => {
  ...
  return `${rootTagStart}
	...
	${object.businessHours == null ? '' : object.businessHours.map(p => '<businessHours>' + p + '</businessHours>')}
	...
	${object.recurrenceDayOfWeek == null ? '' : object.recurrenceDayOfWeek.map(p => '<recurrenceDayOfWeek>' + p + '</recurrenceDayOfWeek>')}
