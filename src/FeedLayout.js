...
module.exports = (object, asChild) => {
  ...
  return `${rootTagStart}
	...
	${object.feedFilters == null ? '' : object.feedFilters.map(p => '<feedFilters>' + FeedLayoutFilter(p, true) + '</feedFilters>').join('')}
	...
	${object.leftComponents == null ? '' : object.leftComponents.map(p => '<leftComponents>' + FeedLayoutComponent(p, true) + '</leftComponents>').join('')}
	${object.rightComponents == null ? '' : object.rightComponents.map(p => '<rightComponents>' + FeedLayoutComponent(p, true) + '</rightComponents>').join('')}
