...
module.exports = (object, asChild) => {
  ...
  return `${rootTagStart}
	...
	${object.inputParameters == null ? '' : object.inputParameters.map(p => '<inputParameters>' + FlowApexPluginCallInputParameter(p, true) + '</inputParameters>').join('')}
	${object.outputParameters == null ? '' : object.outputParameters.map(p => '<outputParameters>' + FlowApexPluginCallOutputParameter(p, true) + '</outputParameters>').join('')}
