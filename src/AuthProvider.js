...
module.exports = (object, asChild) => {
  ...
  return `${rootTagStart}
	${object.appleTeam == null ? '' : '<appleTeam>' + object.appleTeam + '</appleTeam>'}
	...
	${object.ecKey == null ? '' : '<ecKey>' + object.ecKey + '</ecKey>'}
	...
	${object.linkKickoffUrl == null ? '' : '<linkKickoffUrl>' + object.linkKickoffUrl + '</linkKickoffUrl>'}
	${object.logoutUrl == null ? '' : '<logoutUrl>' + object.logoutUrl + '</logoutUrl>'}
	${object.oauthKickoffUrl == null ? '' : '<oauthKickoffUrl>' + object.oauthKickoffUrl + '</oauthKickoffUrl>'}
	...
	${object.sendSecretInApis == null ? '' : '<sendSecretInApis>' + object.sendSecretInApis + '</sendSecretInApis>'}
	${object.ssoKickoffUrl == null ? '' : '<ssoKickoffUrl>' + object.ssoKickoffUrl + '</ssoKickoffUrl>'}
