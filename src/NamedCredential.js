...
module.exports = (object, asChild) => {
  ...
  return `${rootTagStart}
	...
	${object.authTokenEndpointUrl == null ? '' : '<authTokenEndpointUrl>' + object.authTokenEndpointUrl + '</authTokenEndpointUrl>'}
	${object.awsAccessKey == null ? '' : '<awsAccessKey>' + object.awsAccessKey + '</awsAccessKey>'}
	${object.awsAccessSecret == null ? '' : '<awsAccessSecret>' + object.awsAccessSecret + '</awsAccessSecret>'}
	${object.awsRegion == null ? '' : '<awsRegion>' + object.awsRegion + '</awsRegion>'}
	${object.awsService == null ? '' : '<awsService>' + object.awsService + '</awsService>'}
	...
	${object.jwtAudience == null ? '' : '<jwtAudience>' + object.jwtAudience + '</jwtAudience>'}
	${object.jwtFormulaSubject == null ? '' : '<jwtFormulaSubject>' + object.jwtFormulaSubject + '</jwtFormulaSubject>'}
	${object.jwtIssuer == null ? '' : '<jwtIssuer>' + object.jwtIssuer + '</jwtIssuer>'}
	${object.jwtSigningCertificate == null ? '' : '<jwtSigningCertificate>' + object.jwtSigningCertificate + '</jwtSigningCertificate>'}
	${object.jwtTextSubject == null ? '' : '<jwtTextSubject>' + object.jwtTextSubject + '</jwtTextSubject>'}
	${object.jwtValidityPeriodSeconds == null ? '' : '<jwtValidityPeriodSeconds>' + object.jwtValidityPeriodSeconds + '</jwtValidityPeriodSeconds>'}
	...
	${object.privateConnection == null ? '' : '<privateConnection>' + object.privateConnection + '</privateConnection>'}
